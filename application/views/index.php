...
<body>
	...
	<div class="main-wrapper">
		...
		<header class="header">
			...
			<div class="menu">
				<a href="javascript:void(0);" class="login-register-btn">
		...
		<div class="card">
			...
			<div class="content">
				...
				<form id="register-form" onsubmit="return false">
					...
					<input type="hidden" required="" name="register_user" value="1">
					<div class="form-input">
	...
	<script type="text/javascript" src="resources/js/firestore-config.js"></script>
